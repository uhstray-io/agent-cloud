...
Approval must be obtained directly in the coordinating task through its normal approval interface. The rejected broad delegation is not authorization for this narrower operation. The current worker must not execute even these GETs until the restriction is explicitly resolved.
