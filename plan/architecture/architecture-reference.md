...
4. **BASH lint** -- validate any bash script code/blocks
5. **pylint** -- validate any python scripting blocks
...
| 2026-05-10 | Reviewd by @jestyr27, updated some naming conventions and added references to missing documents. |
