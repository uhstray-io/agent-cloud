...
- **Unit Tests**: pytest (95 tests, Python 3.11 — collected from `testpaths` in `pyproject.toml`, run from the repo root so adding a suite is one line there), BATS (459 tests, Bash)
