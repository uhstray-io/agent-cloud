...
When a future Phase 11 PR ships `agents/websmith/context/architecture/integration-with-agent-cloud.md`, that doc will become the authoritative reference for this deviation.
